...
![visitors](https://visitor-badge.laobi.icu/badge?page_id=[page.id](https://github.com/luislizcano/3D-wetlands-app/))
...
The 3D Wetlands App is open access through GEE. The users do not require a GEE account to use all the features available in the [app interface](https://lizcanosandoval.users.earthengine.app/view/hr-land-cover-gulf-of-mexico). If the user has a GEE account can have access to an [advanced version](https://code.earthengine.google.com/72eabf9c8375509a552653b5e493bee1) which will allow to export data to the respective Google Drive account by clicking a button. To this point previous experience with GEE is **not required**. However, the access of the landcover and DEM collections for other specific uses through the code editor previous knowledge with GEE is required (See the [GEE Documentation](https://developers.google.com/earth-engine)).
